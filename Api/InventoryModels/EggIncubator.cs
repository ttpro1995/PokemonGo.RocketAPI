...
namespace PokemonGo.RocketAPI.Api.InventoryModels
{
    public class EggIncubator : BaseRpc
    {
        ...
        public async Task<UseItemEggIncubatorResponse> HatchEgg(EggPokemon egg)
        {
            ...
            await _client.Inventories.UpdateInventories(true);
        ...
        {
            return _client.PlayerProfile.Stats.GetKmWalked() - GetKmStart();
        }
        ...
        {
            return GetKmTarget() - _client.PlayerProfile.Stats.GetKmWalked();
        }
